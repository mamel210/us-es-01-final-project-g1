...
from .models import db, Users, TrainingPlans, Exercises, SessionExercises, TrainingExercises, Sessions, MuscleExercises, Categories, Muscles
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(MuscleExercises, db.session))
