...
Revision ID: 4ed5ffa0b707
Revises: 
Create Date: 2024-11-14 18:32:17.917924
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('active', 'completed', 'expired', 'deleted', name='plan_status'), nullable=False),
